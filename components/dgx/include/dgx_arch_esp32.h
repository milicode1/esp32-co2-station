...
static inline void dgx_delay_ns(uint32_t nsDelay)
{
    esp_rom_delay_us((nsDelay + 999) / 1000);
}

static inline void dgx_delay_us(uint32_t usDelay)
{
    esp_rom_delay_us(usDelay);
}
